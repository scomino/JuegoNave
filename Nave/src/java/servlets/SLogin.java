...
public class SLogin extends HttpServlet {
  ...
  EntityManager em = emf.createEntityManager();
        String nick = request.getParameter("realname");
        ...
        if(us.findUser(nick, password)){
            //Añadimos las cookies con el nombre de usuario y contraseña
            ...
            //añadimos un registro a la tabla de partidas con la fecha inicio y la id del usuario
            usuario=us.copyUser(nick,password);
